...
export const moves = {
  ...
  // 아침햇살: moonlight 날씨 분기 (쾌청25% / 평상시22% / 비·싸라기눈·모래바람·소란피기18%)
  ...
  // 불사르기: 상대 화상이면 위력 90 + 화상 해제 (burnOff)
  ...
  // 소금물: 상대 HP 절반 이하면 위력 80 (saltWater)
  ...
  // 트릭플라워: alwaysHit + 무조건 급소 (alwaysCrit)
  ...
  "기합구슬":           { power: 60, type: "격투", accuracy: 70,  alwaysHit: false, effect: null,
                          rank: { chance: 0.1, targetDef: -1, turns: 2 } },
  ...
  // 분함의발구르기: 직전 턴 빗나갔으면 위력 60 (stomping)
  ...
  // 회복봉인: aoeEnemy true → 상대 양쪽에 동시 healBlock
  ...
  "사이코노이즈":   { power: 45, type: "에스퍼", accuracy: 100, alwaysHit: false,
                      effect: { healBlock: true }, targetSelf: false },
  ...
  // 엉겨붙기: 4-5턴 wrap, noSwitch:true (교체 불가)
  "엉겨붙기":   { power: 20, type: "벌레", accuracy: 100, alwaysHit: false, effect: null, wrap: true, noSwitch: true },
  ...
  // 분풀이: 이번 턴 랭크 하락 있으면 위력 60 (vengeance)
  ...
  "초롱초롱눈동자": { power: 0,  type: "페어리", accuracy: 100, alwaysHit: true,  targetSelf: false, effect: null,
                      rank: { targetAtk: -1, turns: 2 } },
  // 달빛: moonlight 날씨 분기 (쾌청25% / 평상시22% / 비·싸라기눈·모래바람·소란피기18%)
  ...
  // 알낳기: 자신 22%, 아군 대상 시 18% 회복 (allyHeal)
  "알낳기":     { power: 0,  type: "노말", accuracy: 100, alwaysHit: true,
                  effect: { heal: 0.22 }, targetSelf: true, allyHeal: 0.18 },
  // 우유마시기: 자신 22%, 아군 대상 시 18% 회복 (allyHeal)
  ...
  "웨이브태클": { power: 70, type: "물",    accuracy: 100, alwaysHit: false, effect: { recoil: 0.33 } },
  // 김밥말이: 4-5턴 wrap, noSwitch:false (교체 가능)
  "김밥말이":   { power: 15, type: "노말", accuracy: 90,  alwaysHit: false, effect: null, wrap: true, noSwitch: false },
