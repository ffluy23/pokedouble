...
export function patchMoveForWeather(weather, moveName, moveInfo) {
  ...
  if (moveName === "눈보라") {
    ...
    // "눈" 날씨에서도 눈보라 필중 (눈여아 필드)
    if (weather === "눈")      return { ...moveInfo, alwaysHit: true, accuracy: 100 }
  }
  return moveInfo
}
