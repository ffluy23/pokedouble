...
// ── 조로아크 기술 ──────────────────────────────────────────────────────
"저주":     { power: 0,  type: "고스트", accuracy: 100, alwaysHit: true },
"섀도크루": { power: 70, type: "고스트", accuracy: 100, alwaysHit: true, highCrit: true },
"앙갚음":   { power: 0,  type: "악",     accuracy: 100, alwaysHit: true },
"분풀이":   { power: 75, type: "악",     accuracy: 100, alwaysHit: true },
"일루전":   { power: 0,  type: "악",     accuracy: 100, alwaysHit: true },
"도발":     { power: 0,  type: "악",     accuracy: 100, alwaysHit: true },
"도둑질":   { power: 0,  type: "악",     accuracy: 100, alwaysHit: true },
"깨트리기": { power: 75, type: "격투", accuracy: 100, alwaysHit: true, breakBarrier: true },

// ── 아이스크 기술 ─────────────────────────────────────────
  "시저크로스": {
    power: 80, type: "벌레", accuracy: 100, alwaysHit: true,
    aoe: true,
  },
  "제비반환": {
    power: 60, type: "비행", accuracy: 100, alwaysHit: true,
  },
  "객기": {
    power: 70, type: "노말", accuracy: 100, alwaysHit: true,
    // 자신이 독/마비/화상 상태일 때 위력 2배
    // → raidBossAction.js의 processBossAttack에서
    //   data.boss_status 를 확인해 calcBossDamage에 powerOverride로 넘김
    gutsLike: true,
  },
  ...
  "흡혈": {
    power: 80, type: "벌레", accuracy: 100, alwaysHit: true,
    ult: true,
    effect: { drain: 0.2 },   // 준 데미지의 20% 회복
  },
  "벌레의야단법석": {
    power: 90, type: "벌레", accuracy: 100, alwaysHit: true,
    ult: true,
    aoe: true,
  },
  ...
  "버티기": {
    power: 90, type: "노말", accuracy: 100, alwaysHit: true,
    aoe: true,
    shedinjaOnly: true,   // 껍질몬 전용 플래그 (참고용)
  },

  "냉동빔":       { type: "얼음",   power: 90,  alwaysHit: true },
"병상첨병":     { type: "고스트", power: 65,  alwaysHit: true },
"섀도볼":       { type: "고스트", power: 80,  alwaysHit: true, aoe: true },
"고드름떨구기": { type: "얼음",   power: 85,  alwaysHit: true },
"눈보라":       { type: "얼음",   power: 120, alwaysHit: true, aoe: true },

// ── 누클라바스 기술 ──────────────────────────────────────────────────
"해수스파우팅": { power: 120, type: "물",    alwaysHit: true, aoe: true  },
"분화":         { power: 120, type: "불",    alwaysHit: true, aoe: true  },
"지진":         { power: 120, type: "땅",    alwaysHit: true, aoe: true  },
"번개":         { power: 120, type: "전기",  alwaysHit: true             },
"눈보라":       { power: 120, type: "얼음",  alwaysHit: true, aoe: true  },
"하드플랜트":   { power: 120, type: "풀",    alwaysHit: true, aoe: true  },
"파괴광선":     { power: 120, type: "노말",  alwaysHit: true             },
"에어슬래시":   { power: 120, type: "비행",  alwaysHit: true, aoe: true  },
"드래곤크루":   { power: 120, type: "드래곤",alwaysHit: true             },

// ── 누클라바스 ult ──────────────────────────────────────────────────
"카타스트로피": { power: 120, type: "악",    alwaysHit: true, aoe: true, ult: true },
